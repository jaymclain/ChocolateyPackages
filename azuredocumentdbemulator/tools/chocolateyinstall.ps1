...
$packageName= 'azuredocumnetdbemulator' # arbitrary name for the package, used in messages
$toolsDir   = "$(Split-Path -parent $MyInvocation.MyCommand.Definition)"
$url        = 'https://aka.ms/documentdb-emulator' # download url
...
$packageArgs = @{
  ...
  softwareName  = 'Microsoft Azure DocumentDB Emulator' #part or all of the Display Name as you see it in Programs and Features. It should be enough to be unique
  checksum      = ''
